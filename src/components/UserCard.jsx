  ...
  return (
    <div className="w-full bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 sm:p-10 flex flex-col sm:flex-row gap-4 sm:gap-8 transition-colors duration-200">
      ...
      <div className="flex-1 w-full">
        {/* Header: Name row (desktop: flex-row with date on right; mobile: flex-col) */}
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
          <div className="flex flex-col">
            {/* Single h2 heading — no DOM duplication */}
          ...
          <span className="text-sm text-gray-500 dark:text-slate-300 sm:pt-2">
            {joinedDate}
          </span>
        </div>
