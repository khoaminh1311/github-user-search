function WelcomeState() {
  return (
    <div className="w-full bg-white rounded-xl border border-gray-200 shadow-sm p-8 sm:p-12 text-center flex flex-col items-center justify-center">
      <svg
        className="w-16 h-16 sm:w-20 sm:h-20 text-slate-400 fill-current mb-4"
        viewBox="0 0 24 24"
        aria-hidden="true"
      >
        <path
